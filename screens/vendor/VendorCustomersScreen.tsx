...
interface VendorCustomersScreenProps {
  user: User;
...
const VendorCustomersScreen: React.FC<VendorCustomersScreenProps> = ({ user, onNavigate, onLogout, orders, notifications }) => {
  ...
  return (
    <DashboardLayout user={user} onNavigate={onNavigate} onLogout={onLogout} activeView={AppView.VENDOR_CUSTOMERS} notifications={notifications}>
