...
const VendorOrderDetailScreen: React.FC<VendorOrderDetailScreenProps> = ({ user, onNavigate, onLogout, order, onBack, onUpdateStatus, notifications }) => {
       ...
       return (
            <DashboardLayout user={user} onNavigate={onNavigate} onLogout={onLogout} activeView={AppView.VENDOR_ORDERS} notifications={notifications}>
                <div className="text-center bg-white p-8 rounded-lg shadow">
                    ...
                    <p className="text-gray-500 mt-2">The selected order could not be found. Please go back and try again.</p>
    ...
    const nextActionText: Partial<Record<OrderStatus, string>> = {
        ...
        'Ready for Pickup': 'Mark as Shipped',
    }
                ...
                <div className="lg:col-span-2 bg-white p-6 rounded-lg shadow-md">
                    ...
                    <div className="flex justify-between items-center pt-4 border-t">
                        ...
                        {nextStatus && nextStatusText && (
                            <button onClick={() => onUpdateStatus(order.id, nextStatus)} className="px-6 py-3 bg-emerald-600 text-white font-semibold rounded-md hover:bg-emerald-700">
                                {nextStatusText}
                            </button>
                        )}
                    </div>
