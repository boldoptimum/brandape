...
const VendorProductsScreen: React.FC<VendorProductsScreenProps> = ({ user, onNavigate, onLogout, products, onAddProduct, onEditProduct, onDeleteProduct, notifications }) => {
