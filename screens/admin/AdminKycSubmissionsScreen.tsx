...
interface AdminKycSubmissionsScreenProps {
  user: User;
...
const AdminKycSubmissionsScreen: React.FC<AdminKycSubmissionsScreenProps> = ({ user, onNavigate, onLogout, users, onViewKyc, notifications }) => {
