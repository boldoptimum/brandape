...
interface CompleteProfileIndividualStep2Props {
  onNavigate: (view: AppView) => void;
  onNavigateHome: () => void;
}

const CompleteProfileIndividualStep2: React.FC<CompleteProfileIndividualStep2Props> = ({ onNavigate, onNavigateHome }) => {
  return (
    <AuthLayout onNavigateHome={onNavigateHome}>
      ...
      <form className="mt-8 space-y-6" onSubmit={(e) => { e.preventDefault(); onNavigate(AppView.COMPLETE_PROFILE_INDIVIDUAL_STEP3); }}>
        <div>
